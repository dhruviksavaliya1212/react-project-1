    ...
    <div className="py-8 overflow-hidden">
      <div className="container">
        <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* second col */}
          <div className="py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/95 text-white rounded-2xl relative h-[320px] flex items-end">
            <div>
              <div className="mb-4">
          ...
          {/* third col */}
          <div className=" sm:col-span-2 py-10 pl-5 sm:pl-14 lg:pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-2xl relative h-[320px] flex items-end">
            <div>
              <div className="mb-4">
