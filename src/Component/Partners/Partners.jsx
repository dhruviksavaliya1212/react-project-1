...
const Partners = () => {
  return (
    <div className='py-8 mt-20 sm:mt-24 block bg-zinc-200/70 dark:bg-black/40 '>
      <div className="container">
        <div data-aos="zoom-in"  className="grid grid-cols-5 gap-3 place-items-center opacity-50">
