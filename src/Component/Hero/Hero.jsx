                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center gap-4 sm:gap-7 sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                      <h1
                        ...
                        data-aos-once="true"
                        className="text-2xl sm:text-4xl lg:text-3xl font-bold"
                      >
                        {data.subtitle}
                      </h1>
                      <h1
                      ...
                      <h1
                        ...
                        data-aos-duration="500"
                        data-aos-once="true"
                        className=" text-[45px] uppercase text-white dark:text-white/5 sm:text-[60px] md:text-[80px] lg:text-[100px] xl:text-[150px] font-bold"
                      >
                        {data.title2}
                      </h1>
